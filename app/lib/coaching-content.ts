...
export const COACHING: Record<TierId, TierCoaching> = {
  ...
  grow: {
    overall: {
      ...
      mostly_red:
        "You have proof that some of this works. Now the job is to stop doing everything manually and start building the systems that let your business run without you in every piece of it. Bring your biggest time drain to a Momentum Call — let's figure out what to hand off first.",
      mixed:
